...
\begin{center}
\vspace*{0.45cm}
\IfFileExists{logo_unab.png}{\includegraphics[height=3.2cm]{logo_unab.png}\\[0.8cm]}{{\Large\bfseries Universidad Andrés Bello}\\[0.8cm]}
...
\textbf{Entregables:} informe PDF, notebook \texttt{S2\_Validacion.ipynb}, repositorio GitHub y archivos de resultados validados.\\
